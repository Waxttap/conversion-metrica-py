# Paso 1: Solicitar al usuario las medidas de la pieza del mueble en centimetros

medida_en_cms = int(input("por favor, ingresar las medidas de la pieza del mueble (en centimetros): "))
